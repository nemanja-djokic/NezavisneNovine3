...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mSelectedVijest != null) {
            ...
            setAdapter(mAdapter);
            initializeBackground(mSelectedVijest);
        ...
        Glide.with(getActivity())
                ...
                .into(new SimpleTarget<Bitmap>() {
                    ...
                    public void onResourceReady(Bitmap bitmap,
                        ...
                        //Bitmap blurredBitmap = ImageProcess.doGaussianBlur(bitmap, 5);
    ...
    private void setupDetailsOverviewRow() {
        ...
        final DetailsOverviewRow row = new DetailsOverviewRow(mSelectedVijest);
        row.setImageDrawable(
                ContextCompat.getDrawable(getActivity(), R.drawable.nezavisne3));
        int width = convertDpToPixel(getActivity().getApplicationContext(), DETAIL_THUMB_WIDTH);
        int height = convertDpToPixel(getActivity().getApplicationContext(), DETAIL_THUMB_HEIGHT);
        Glide.with(getActivity())
                .load(mSelectedVijest.getSlikaURL().get(0))
                .centerCrop()
                .error(R.drawable.nezavisne3)
    ...
    private void prepareRelatedNews(){
        ...
        for (int i = 0; i < nizPocetni.size(); i++) {
            ...
            int kategorija = object.getAsJsonPrimitive("meniRoditelj").getAsInt();
            vijest.setVijestID(vijestID);
            vijest.setMeniID(kategorija);
